...
/*
 **********Executing NwChem Application on Comet**********
 * Created by Eroma on 8/11/16.
 * The script generates PSI4.0 application execution on Comet
 * experiment-name and experiment-description are read from the exp.properties file
*/

public class PSIComet extends UserLogin {
    ...
    @Test
    public void testPSIComet() throws Exception {
        ...
        driver.findElement(By.id("experiment-name")).sendKeys(expName + "PSI4.0-Comet");
        waitTime (200);
        ...
        waitTime (200);
        new Select(driver.findElement(By.id("application"))).selectByVisibleText("PSI4.0");
        waitTime (200);
        driver.findElement(By.name("continue")).click();
        waitTime (200);
        driver.findElement(By.id("Psi-Input-File")).sendKeys(ExpFileReadUtils.PSI_INPUT1);
        waitTime (200);
        waitTime (200);
