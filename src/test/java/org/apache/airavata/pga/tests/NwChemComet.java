 ...
 * Created by Eroma on 3/13/15.
 * The script generates NwChem application execution on Trestles
...
public class NwChemComet extends UserLogin {
  ...
  @Test
  public void testNwChemComet() throws Exception {
