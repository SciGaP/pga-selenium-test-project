...
public class GaussianCarbonate extends UserLogin {
  ...
  @Test
  public void testGaussianCarbonate() throws Exception {
    ...
    driver.findElement(By.cssSelector("li.dropdown.open > ul.dropdown-menu > li > #create")).click();
      waitTime(200);
    driver.findElement(By.id("experiment-name")).sendKeys(expName + "Gaussian-Carbonate");
      waitTime(200);
    ...
    new Select(driver.findElement(By.id("project"))).selectByVisibleText (ExpFileReadUtils.readProperty("project.name"));
      waitTime(200);
    new Select(driver.findElement(By.id("application"))).selectByVisibleText("Gaussian16");
      waitTime(200);
    driver.findElement(By.name("continue")).click();
      waitTime(200);
    driver.findElement(By.id("Input-File")).sendKeys(ExpFileReadUtils.GAUSSIAN_INPUT3);
      waitTime(200);
    new Select(driver.findElement(By.id("compute-resource"))).selectByVisibleText("carbonate.uits.iu.edu");
      waitTime (200);
