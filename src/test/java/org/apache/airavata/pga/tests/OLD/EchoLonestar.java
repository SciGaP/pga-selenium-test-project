...
public class EchoLonestar extends UserLogin {
  ...
  @Test
  public void testEchoLonestar() throws Exception {
    ...
    driver.findElement(By.id("experiment-name")).sendKeys(expName + "Echo-Lonestar");
      waitTime (200);
    ...
    driver.findElement(By.name("continue")).click();
      waitTime (200);
    driver.findElement(By.id("Input-to-Echo")).clear();
    driver.findElement(By.id("Input-to-Echo")).sendKeys("Echo Test");
      waitTime (200);
    new Select(driver.findElement(By.id("compute-resource"))).selectByVisibleText("lonestar.tacc.utexas.edu");
      waitTime (200);
    ...
    driver.findElement(By.id("cpu-count")).sendKeys("12");
