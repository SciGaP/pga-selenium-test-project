...
public class CPMDKarst extends UserLogin {
  ...
  @Test
  public void testCPMDKarst() throws Exception {
    ...
    driver.findElement(By.cssSelector("li.dropdown.open > ul.dropdown-menu > li > #create")).click();
      waitTime(200);
    driver.findElement(By.id("experiment-name")).sendKeys(expName + "CPMD-Karst");
      waitTime(200);
