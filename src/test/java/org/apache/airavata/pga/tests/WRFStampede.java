...
/*
 **********Executing WRF Application on Stampede**********
 * Created by Airavata on 9/16/14.
 * The script generates WRF application execution on Stampede
...
public class WRFStampede extends UserLogin {
  ...
  @Test
  public void testWRFStampede() throws Exception {
    ...
    driver.findElement(By.id("experiment-name")).sendKeys(expName + "WRF-Stampede");
      waitTime(200);
    ...
    new Select(driver.findElement(By.id("project"))).selectByVisibleText(ExpFileReadUtils.readProperty("project.name"));
      waitTime(200);
    new Select(driver.findElement(By.id("application"))).selectByVisibleText("WRF");
      waitTime(200);
    driver.findElement(By.name("continue")).click();
      waitTime(200);
    driver.findElement(By.id("Configuration-Namelist-File")).sendKeys(ExpFileReadUtils.WRF_INPUT1);
      waitTime(200);
    driver.findElement(By.id("WRF-Initial-Conditions")).sendKeys(ExpFileReadUtils.WRF_INPUT2);
      waitTime(200);
    driver.findElement(By.id("WRF-Boundary-File")).sendKeys(ExpFileReadUtils.WRF_INPUT3);
      waitTime(200);
