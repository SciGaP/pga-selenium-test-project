...
public class QuantumEspressoLonestar extends UserLogin {
  ...
  @Test
  public void testQuantumEspressoLonestar() throws Exception {
    ...
    driver.findElement(By.id("experiment-name")).sendKeys(expName + "QEspresso-Lonestar");
      waitTime (200);
