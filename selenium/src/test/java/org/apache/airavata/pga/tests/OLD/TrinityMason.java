...
public class TrinityMason extends UserLogin {
  ...
  @Test
  public void testTrinityMason() throws Exception {
    ...
    driver.findElement(By.id("experiment-name")).sendKeys(expName + "Trinity-Mason");
      waitTime (200);
    ...
    driver.findElement(By.name("continue")).click();
      waitTime(200);
    driver.findElement(By.id("Seq_Type")).clear();
    driver.findElement(By.id("Seq_Type")).sendKeys("fq");
      waitTime(200);
    driver.findElement(By.id("JM")).clear();
    driver.findElement(By.id("JM")).sendKeys("2G");
      waitTime(200);
    driver.findElement(By.id("RNA-Seq-Left-Input")).sendKeys(ExpFileReadUtils.TRINITY_INPUT1);
      waitTime(200);
    driver.findElement(By.id("RNA-Seq-Right-Input")).sendKeys(ExpFileReadUtils.TRINITY_INPUT2);
      waitTime (200);
    driver.findElement(By.id("SS_Lib_Type")).clear();
    driver.findElement(By.id("SS_Lib_Type")).sendKeys("RF");
      waitTime (200);
    driver.findElement(By.id("CPU")).clear();
    driver.findElement(By.id("CPU")).sendKeys("4");
      waitTime (200);
    driver.findElement(By.id("Max_HeapSpace")).clear();
    driver.findElement(By.id("Max_HeapSpace")).sendKeys("2G");
      waitTime (200);
    new Select(driver.findElement(By.id("compute-resource"))).selectByVisibleText("mason.indiana.edu");
      waitTime (200);
